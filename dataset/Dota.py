...
def convert_coco_poly_to_mask(segmentations, height, width):
    ...
    for polygons in segmentations:
        rles = polygons ##coco_mask.frPyObjects(polygons, height, width)
...
class ConvertCocoPolysToMask(object):
    ...
    def __call__(self, image, target):
        ...
        classes = [1 for obj in anno]  #obj["category_id"]
    ...
    if image_set == "train":
        return T.Compose(
            [
                ...
                T.ResizeLongestSide(target_length = 1024),
                normalize,
            ]
        )
...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "val": (root / "test2017", root / "annotations" / f"{mode}_test2017.json"),
    }
